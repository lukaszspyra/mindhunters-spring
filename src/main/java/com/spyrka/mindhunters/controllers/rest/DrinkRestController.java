...
/**
 * Used to receive {@link com.spyrka.mindhunters.models.User} requests to delete or update drink recipes
 */
@RestController
...
public class DrinkRestController {
     ...
     * @param req            containing {@link com.spyrka.mindhunters.models.User} email
     */
    @PostMapping("/{id}")
